        ...
        <div class="form-content">
            ...
            @csrf
                <div class="field input-field">
                    ...
                    @error('email')
                    <p class="error text-black-500 text-xs mt-1">{{$message}}</p>
                    @enderror
                </div>
                <div class="field input-field">
                    <input type="password" placeholder="Password" class="password" value="{{ old('password') }}">
            ...
            <div class="form-link">
                <span>Don't have an account? <a href="{{ route('signupform') }}" class="link signup-link">Sign up!</a></span>
            </div>
        </div>
    </div>
@endsection
